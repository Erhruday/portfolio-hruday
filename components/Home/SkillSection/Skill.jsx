    ...
    return (
        <div className={style['skill-wrapper']}>
            <Container maxWidth="md">
                ...
                <p className={style['description']}>
                    Visit my <span className={style['highlight-description']}>LinkedIn</span> profile for more details or just{' '}
                    <span className={style['highlight-description']}>contact </span> me.
                </p>
